    ...
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent side="bottom" className="rounded-t-3xl px-6 pb-8 pt-6 max-h-[80vh] overflow-y-auto">
        <SheetHeader className="mb-6">
          <SheetTitle className="text-lg font-semibold text-center">Choose an icon and color</SheetTitle>
        </SheetHeader>
        ...
        {/* Color Selection */}
        <div className="mb-6">
          <label className="text-sm font-medium text-muted-foreground mb-3 block">Color</label>
        ...
        {/* Custom Emoji Input */}
        <div className="mb-6">
          <label className="text-sm font-medium text-muted-foreground mb-2 block">Custom icon</label>
          <Input
            value={customEmoji}
